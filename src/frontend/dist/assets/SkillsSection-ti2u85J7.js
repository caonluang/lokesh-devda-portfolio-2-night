import { r as reactExports, _ as __vitePreload, j as jsxRuntimeExports, S as SKILLS } from "./index-DuMneQu4.js";
const SKILL_ABBR = {
  CorelDraw: "Cd",
  Illustrator: "Ai",
  Photoshop: "Ps",
...
function SkillCard({ skill, index }) {
  ...
  const [displayPercent, setDisplayPercent] = reactExports.useState(0);
  const animatedRef = reactExports.useRef(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center pointer-events-none", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-semibold text-white/50", children: [
                  displayPercent,
                  "%"
                ] })
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-sm md:text-base mb-1 leading-tight", children: skill.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-white/35 mb-4", children: [
          skill.years,
          " years"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              background: "radial-gradient(ellipse at 80% 30%, rgba(124,58,237,0.1) 0%, transparent 55%), radial-gradient(ellipse at 20% 70%, rgba(0,245,255,0.07) 0%, transparent 50%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              background: "linear-gradient(90deg, transparent, rgba(124,58,237,0.4) 30%, rgba(0,245,255,0.4) 70%, transparent)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end md:justify-between gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-title text-4xl md:text-5xl lg:text-6xl text-white", children: [
                  "Skills & ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-cyan", children: "Tools" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-lg mt-3 max-w-lg", children: "Precision tools wielded with 5+ years of creative mastery" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-white/40 tracking-widest uppercase", children: stat.label })
                      ]
                    },
                    stat.label
                  ))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: SKILLS.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCard, { skill, index: i }, skill.name))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              "aria-hidden": "true",
              children: SKILLS.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-white/30", children: skill.name })
              ] }, skill.name))
            }
          )
        ] })

...
const TIMELINE = [
  {
    ...
    description: "Started my design journey crafting digital assets, social media creatives, and brand collaterals for diverse clients across industries.",
    color: "#7c3aed"
  },
  {
    year: "October 2022",
    ...
    description: "Created award certificates, promotional materials, and press kits for a prestigious recognition platform honoring achievers across India.",
    color: "#00f5ff"
  },
  {
    year: "January 2023",
    ...
    description: "Led design projects including brand identity systems, packaging design, and digital marketing campaigns for multiple brand portfolios.",
    color: "#ff2d55"
  },
  {
    year: "June 2023",
    ...
    description: "Specialized in print-ready designs, large format graphics, and prepress production for commercial printing projects.",
    color: "#f5a623"
  },
  {
    year: "February 2024",
    ...
    description: "Currently leading creative direction, building brand identities, and developing web interfaces for clients across retail, hospitality, and tech sectors.",
    isCurrent: true,
    color: "#a855f7"
  }
];
...
function CustomCursor() {
  ...
  reactExports.useEffect(() => {
    ...
    const onEnter = () => {
      var _a2, _b2;
      (_a2 = dotRef.current) == null ? void 0 : _a2.classList.add("scale-150");
      (_b2 = ringRef.current) == null ? void 0 : _b2.classList.add("scale-150");
    };
    const onLeave = () => {
      var _a2, _b2;
      (_a2 = dotRef.current) == null ? void 0 : _a2.classList.remove("scale-150");
      (_b2 = ringRef.current) == null ? void 0 : _b2.classList.remove("scale-150");
    };
...
function Layout({ children }) {
  ...
  reactExports.useEffect(() => {
    let animId;
    let lenisDestroy = null;
    __vitePreload(async () => {
      const { default: Lenis } = await import("./lenis-DjXFbXFa.js");
      return { default: Lenis };
    }, true ? [] : void 0).then(({ default: Lenis }) => {
    ...
    return () => {
      cancelAnimationFrame(animId);
      lenisDestroy == null ? void 0 : lenisDestroy();
    };
  }, []);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-portfolio-primary text-foreground overflow-x-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block font-display font-semibold text-sm tracking-widest uppercase opacity-70 group-hover:opacity-100 transition-opacity", children: "Lokesh Devda" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "rgba(255,255,255,0.4)" }, children: [
          "© ",
...
const HeroSection = reactExports.lazy(() => __vitePreload(() => import("./HeroSection-CvxH0i_x.js"), true ? [] : void 0));
const AboutSection = reactExports.lazy(() => __vitePreload(() => import("./AboutSection-LXQtViQz.js"), true ? [] : void 0));
const CategoriesSection = reactExports.lazy(() => __vitePreload(() => import("./CategoriesSection-yN0e_I6u.js"), true ? [] : void 0));
const GallerySection = reactExports.lazy(() => __vitePreload(() => import("./GallerySection--SXy6PCh.js"), true ? [] : void 0));
const TimelineSection = reactExports.lazy(() => __vitePreload(() => import("./TimelineSection-gCV7FFBb.js"), true ? [] : void 0));
const SkillsSection = reactExports.lazy(() => __vitePreload(() => import("./SkillsSection-ti2u85J7.js"), true ? [] : void 0));
const ContactSection = reactExports.lazy(() => __vitePreload(() => import("./ContactSection-DIUk4enY.js"), true ? [] : void 0));
function SectionFallback() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-32 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function App() {
  const [activeCategoryId, setActiveCategoryId] = reactExports.useState(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoriesSection, { onCategorySelect: setActiveCategoryId }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      GallerySection,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(TimelineSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactSection, {}) })
  ] });
}
